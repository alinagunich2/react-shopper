...
const AddProduct = () => {
  ...
  return (
    <div className="addproduct box-border w-full py-7 px-12 my-5 mx-8 rounded-md bg-white">
      ...
      <div className="addproduct-itemfield mb-11 text-[#7b7b7b] w-full">
        <p>Product Category</p>
        <select
          value={productDetails.category}
          onChange={changeHandler}
          name="category"
          className="addproduct-selectors p-3 w-24 h-12 text-sm text-[#7b7b7b] border border-solid border-[#7b7b7b8d] rounded"
          id=""
        >
      ...
      <button
        onClick={Add_Product}
        className="addproduct-btn  w-40 h-12 rounded-md border-spacing-0 bg-blue-400 cursor-pointer text-white text-base font-medium"
      >
        ADD
      </button>
    </div>
